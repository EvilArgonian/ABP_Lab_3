...
public class ABPLab3 {
	public static void main(String[] args) throws Exception
	{
		...
		// a random DNA 30 mer
		System.out.println(RandSeq.generateRandomSequence(dnaChars, dnaWeights, 30));
		...
		System.out.println(RandSeq.generateRandomSequence(proteinResidues, proteinBackground, 30));
